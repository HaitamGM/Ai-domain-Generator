...
//             icon.className = checkbox.checked ? "fas fa-check-square" : "far fa-square";
//             updateSelectedCount();
//         };
...
//         option.querySelector('.checkbox-icon').className = "fas fa-check-square";
//     });
//     updateSelectedCount();
// });
...
//         option.querySelector('.checkbox-icon').className = "far fa-square";
//     });
//     updateSelectedCount();
// });
